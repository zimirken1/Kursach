...
class UserController {
  async registration(req: RequestWithBody<UserLoginModel>, res: Response<UserUpdateModel>, next: NextFunction) {
    try {
  ...
  async login(req: RequestWithBody<UserLoginModel>, res: Response<UserUpdateModel>, next: NextFunction) {
    try {
      const { email, password } = req.body;
  ...
  async refresh(req: Request, res: Response<UserUpdateModel>, next: NextFunction) {
    try {
      const { refreshToken } = req.cookies;
